...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/httpcore2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/httpcore2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Installing httpcore2
====================

Installing `httpcore2` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Once the `conda-forge` channel has been enabled, `httpcore2` can be installed with `conda`:

```
conda install httpcore2
```

or with `mamba`:

```
mamba install httpcore2
```

It is possible to list all of the versions of `httpcore2` available on your platform with `conda`:
...
Updating httpcore2-feedstock
============================

If you would like to improve the httpcore2 recipe or build a new
...
Note that all branches in the conda-forge/httpcore2-feedstock are
